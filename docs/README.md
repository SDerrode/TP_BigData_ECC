...
### Séance #4 - TP _Linked Data_ et _SparQL_ (1/2)
  ...
  - **Travaux pratiques**
  > - Finissez de coder les requêtes du [TP1](./TP1). _Remarque_ : N'hésitez pas à sauvegarder vos requêtes dans un fichier texte (au format _Markdown_ ?), de manière à pouvoir les rejouer plus tard.
...
### Séance #5 - TP _Linked Data_ et _SparQL_ (2/2)
  ...
  > - Choisissez une base de données `linked data` (autre que _DBPedia_) et inventez **deux requêtes** sur cette base. Vous pouvez utiliser une des bases vues en cours, ou en chercher une nouvelle à partir de ces sites :
       > 
     >   - [The Linked Open Data Cloud](https://lod-cloud.net/datasets). _Remarque_ : Ce lien ne fonctionnait plus lors de mon dernier essai le 26.20.2021    
...
### Séance #6 - cours _Hadoop_ (1/2)
  ...
  > - Présentation du [TP #2](./TP2) qui se déroulera en séance #7.

  - **Travail hebdomadaire à faire pour la séance suivante**
  > - En préparation à ce [TP #2](./TP2), installez _Docker_ et le container _Docker Linux/Hadoop_ selon les consignes données sur [ce lein](./TP2/Install_Docker_Hadoop/). Attention, le téléchargement est très volumineux et nécessite une machine avec au moins 3 GO libre de disque dur! Prenez-vous en avance pour faire cette installation!


**Remarque** La suite de ce guide sera modifiée pour prendre en compte ma venue à l'ECC en Janvier 2022. 
...
---
### Séances #8 et #9 - TP _Hadoop_

  - **Travaux pratiques**
  > - Avancez sur la seconde partie du [TP #2](./TP2) concernant précisément `Hadoop map-reduce`.
  > - Commencez le travail à rendre pour la semaine suivante.

  - **Travail à rendre pour la prochaine séance**
  > - Déposez l'algorithme _map-reduce_ correspondant à l'exercice intitulé `Énoncé du CR de TP2`  (uniquement cet exercice) sur la plateforme [edunao](https://centrale-casablanca.edunao.com/course/view.php?id=179) **au plus tard le jour du cours suivant**. Le site de la plateforme est programmé pour ne plus accepter de dépôt au-delà. 
...
### Séance #10 - cours _Spark_ 
  ...
  > - Avancez jusqu'à réaliser la section `wordcount en Spark` de la partie 2 du TP.
...
### Séance #11 et #12 - TP _Spark_
  ...
  - **Travaux pratiques**
  > - Terminez le [TP #3](./TP3), depuis la section `Tester les scripts vus en cours`. 
<!--  > - La partie 4 de ce TP (portant sur _Spark streaming_) est optionnelle.-->

  - **Travail hebdomadaire à faire pour la séance suivante**
  > - Déposez le CR (écrit en _Markdown_) qui portera sur l'algorithme _pyspark_ de l'exercice 2 de la partie 3 du TP (uniquement cet exercice portant sur une base de films) sur la plateforme [edunao](https://centrale-casablanca.edunao.com/course/view.php?id=179) **Deadline : ?????**. Le site de la plateforme est programmé pour ne plus accepter de dépôt au-delà. 
